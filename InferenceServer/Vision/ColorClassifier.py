...
HSV_CATEGORIES = [
    ...
    ("연두",     36,   55,   35,  255,   60,  255),
    ("분홍",      0,   12,   22,   80,  150,  255),
    ("분홍",    160,  179,   22,   80,  150,  255),
    # 차가운 조명이 연분홍을 자홍(H≈135~160)·저채도로 밀어냄.
    # 흰 알약은 잔여 cyan(H≈85~110)이라 이 hue 대역엔 안 들어옴 →
    # 저채도라도 H 135~160 은 연분홍으로 판정(보라는 S≥50 로 별도).
    ("분홍",    135,  160,   10,   49,  160,  255),
